<template>
  <div id="sales">
<el-form :inline="true" :model="formInline" class="demo-form-inline sel_form">
...
export_Excel () {
  this.$confirm('确定要导出表格数据么？', '提示', {
    ...
    require.ensure([], () => {
      ...
      const tHeader =['账套','销售品牌','销售渠道','销售部门','销售业务','销售终端','货品编号','货品中类','销售金额','退返金额','退货金额','销售返点','销售折让','净销售额','销售成本',
      '退货成本','净销成本','销售毛利','毛利率',]
      const filterVal =['affiliateName','brandName','salesChannelName','salesDepartmentName','sellingOperationName','salesTerminalName',
      'prdNo','prdIndx','saAmtn','sbsAmatn','sbAmtn','ssAmtn','sdAmtn','snAmtn','saCst','sbCst','snCst','gP','gPM']
 ...
 arr2json(arr){
    ...
    //  tab_param.append("reprotNo",'SATGS');
     ...
     tab_param.append("reporyBusiness",'SA');
    ...
    // tab_param.append("custNo", tiao_pa.custNo);//''
     ...
     tab_param.append("chk_User", tiao_pa.chk_User);
      ...
      .then((response)=>{
        ...
        this.cols = response.data.Head.split(',')
 ...
 tab_data(head,arr){
       var box = document.getElementsByClassName('__view')[0]
          if( head == '账套名称,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
            arr.forEach((g,h)=>{
             console.log(g.biln_DD)
              ...
              catr.innerHTML=`
                  ...
                  <td style='text-align: right;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.saAmtn == null?'':g.saAmtn}</td> 
                    <td style='text-align: right;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.sbAmtn == null?'':g.sbAmtn}</td> 
                    <td style='text-align: right;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.ssAmtn == null?'':g.ssAmtn}</td>
                    <td style='text-align: right;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.sdAmtn == null?'':g.sdAmtn}</td>  
                    <td style='text-align: right;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.snAmtn == null?'':g.snAmtn}</td> 
                     <td style='text-align: right;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.saCst == null?'':g.saCst}</td> 
                     <td style='text-align: right;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.sbCst == null?'':g.sbCst}</td> 
                     <td style='text-align: right;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.snCst == null?'':g.snCst}</td> 
                     <td style='text-align: right;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.gP == null?'':g.gP}</td> 
                     <td style='text-align: right;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.gPM == null?'':g.gPM}</td> 
              `
              console.log(catr)
               box.appendChild(catr)
            })
          }
           if( head == '账套名称,销售渠道,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
            arr.forEach((g,h)=>{
             console.log(g.biln_DD)
              var catr = document.createElement('tr')
          ...
          if( head == '账套名称,销售渠道,销售部门,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
            arr.forEach((g,h)=>{
             console.log(g.biln_DD)
              var catr = document.createElement('tr')
          ...
          if( head == '账套名称,销售渠道,销售终端,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
            arr.forEach((g,h)=>{
             console.log(g.biln_DD)
              var catr = document.createElement('tr')
          ...
          if( head == '账套名称,销售渠道,销售业务,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
            arr.forEach((g,h)=>{
             console.log(g.biln_DD)
              var catr = document.createElement('tr')
          ...
          if( head == '账套名称,销售部门,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
            arr.forEach((g,h)=>{
             console.log(g.biln_DD)
              var catr = document.createElement('tr')
          ...
          if( head == '账套名称,销售部门,销售终端,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
            arr.forEach((g,h)=>{
             console.log(g.biln_DD)
              var catr = document.createElement('tr')
           ...
           if( head == '账套名称,销售部门,销售业务,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
            arr.forEach((g,h)=>{
             console.log(g.biln_DD)
              var catr = document.createElement('tr')
           ...
           if( head == '账套名称,销售终端,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
            arr.forEach((g,h)=>{
             console.log(g.biln_DD)
              var catr = document.createElement('tr')
           ...
           if( head == '账套名称,销售品牌,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
            arr.forEach((g,h)=>{
             console.log(g.biln_DD)
              var catr = document.createElement('tr')
              ...
              catr.innerHTML=`
                  <td style='text-align: center;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.affiliateName}</td> 
                    <td style='text-align: center;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.brandName == null?'':g.brandName}</td> 
          ...
          if( head == '账套名称,销售品牌,销售渠道,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
          ...
          if( head == '账套名称,销售品牌,销售渠道,商品中类,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
              ...
              catr.innerHTML=`
                  <td style='text-align: center;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    ...
                    font-family: seri'>${g.salesChannelName == null?'':g.salesChannelName}</td> 
                    <td style='text-align: center;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.prdIndx == null?'':g.prdIndx}</td> 

                  <td style='text-align: right;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.saAmtn == null?'':g.saAmtn}</td> 
                    <td style='text-align: right;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.sbsAmatn == null?'':g.sbsAmatn}</td> 
          ...
          if( head == '账套名称,销售品牌,销售渠道,商品中类,商品编号,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
              ...
              catr.innerHTML=`
                  <td style='text-align: center;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    ...
                    font-family: seri'>${g.prdIndx == null?'':g.prdIndx}</td> 
                     <td style='text-align: center;-webkit-box-flex: 1;flex: 1;border-collapse: collapse; font-size: 14px;
                    font-family: seri'>${g.prdNo == null?'':g.prdNo}</td> 
           ...
           if( head == '账套名称,销售品牌,销售渠道,商品编号,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
          ...
          //品牌+业务报错
           if( head == '账套名称,销售品牌,销售业务,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
          ...
          if( head == '账套名称,销售品牌,销售部门,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
          ...
          if( head == '账套名称,销售品牌,销售部门,商品中类,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
           ...
           if( head == '账套名称,销售品牌,销售部门,商品中类,商品编号,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
           ...
           if( head == '账套名称,销售品牌,销售终端,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
          ...
          if( head == '账套名称,销售品牌,销售终端,商品中类,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
          ...
          if( head == '账套名称,销售品牌,销售终端,商品中类,商品编号,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
           ...
           if( head == '账套名称,销售品牌,销售终端,商品编号,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
          ...
          if( head == '账套名称,销售品牌,商品中类,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
          ...
          if( head == '账套名称,销售品牌,商品中类,商品编号,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
           ...
           if( head == '账套名称,销售品牌,商品编号,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
           ...
           if( head == '账套名称,销售品牌,销售业务,商品中类,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
          ...
          if( head == '账套名称,销售品牌,销售业务,商品中类,商品编号,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
          ...
          if( head == '账套名称,销售品牌,销售业务,商品编号,销售金额,退返金额,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
           ...
           if( head == '账套名称,销售业务,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
          ...
          if( head == '账套名称,销售业务,销售终端,销售金额,退货金额,销售返点,销售折让,净销售额,销售成本,退货成本,净销成本,销售毛利,毛利率'){
               box.innerHTML=''
              arr.forEach((g,h)=>{
              var catr = document.createElement('tr')
              catr.style.width= '100%'
...
// <td v-if="item.prdNo?true:false">{{item.prdNo== null ?'':item.prdNo}}</td> <!-- 货品编号 -->
// <td v-if="item.prdIndx?true:false">{{item.prdIndx== null ?'':item.prdIndx}}</td> <!-- 货品中类 -->
// <td v-if="item.saAmtn?true:false">{{item.saAmtn== null ?'':item.saAmtn}}</td> <!--  销售金额-->
// <td v-if="item.sbsAmatn?true:false">{{item.sbsAmatn== null ?'':item.sbsAmatn}}</td> <!-- 退返金额 -->
// <td v-if="item.sbAmtn?true:false">{{item.sbAmtn== null ?'':item.sbAmtn}}</td> <!-- 退货金额 -->
// <td v-if="item.ssAmtn?true:false">{{item.ssAmtn== null ?'':item.ssAmtn}}</td> <!-- 销售返点 -->
// <td v-if="item.sdAmtn?true:false">{{item.sdAmtn== null ?'':item.sdAmtn}}</td> <!-- 销售折让 -->
// <td v-if="item.snAmtn?true:false">{{item.snAmtn== null ?'':item.snAmtn}}</td> <!-- 净销售额 -->
// <td v-if="item.saCst?true:false">{{item.saCst== null ?'':item.saCst}}</td> <!-- 销售成本 -->
// <td v-if="item.sbCst?true:false">{{item.sbCst== null ?'':item.sbCst}}</td> <!-- 退货成本 -->
// <td v-if="item.snCst?true:false">{{item.snCst== null ?'':item.snCst}}</td> <!-- 净销成本 -->
// <td  v-if="item.gP?true:false">{{item.gP== null ?'':item.gP}}</td> <!-- 销售毛利 -->
// <td  v-if="item.gPM?true:false">{{item.gPM== null ?'':item.gPM}}</td> <!-- 毛利率 -->
          //     </tr>
 },
      ...
      report(){
        Modules().then((response)=>{
            ...
            list_data.forEach((i,idx)=>{
                if(i.mod_Level == 'spmsa'){
                    this.list_report.push({
                        mod_Name:i.mod_Name.replace('分支机构','销售'),
                        mod_ID:i.mod_ID,
                    })
...
@media screen and (max-width: 1500px) { /*当屏幕尺寸小于 1400px时，应用下面的CSS样式*/
  .inner_table table {
...
border-collapse:collapse;
 ...
 .inner_table table tbody td:nth-child(1){
text-align: center;
 }
 .inner_table table tbody td:nth-child(2){
   text-align: center;
 }
 h4{
   display: none;
